...
### Aliases: cloud wireframe cloud.formula cloud.data.frame cloud.matrix
###   cloud.table wireframe.formula wireframe.data.frame wireframe.matrix
### Keywords: hplot
...
###   histogram.data.frame densityplot densityplot.numeric
###   densityplot.formula densityplot.data.frame do.breaks
### Keywords: hplot
...
## Not run: 
##D ## change default settings for subsequent plots
##D lattice.options(default.args = list(as.table = TRUE,
##D                                     grid = TRUE,
##D                                     auto.key = TRUE))
## End(Not run)
...
### Aliases: levelplot contourplot levelplot.formula levelplot.data.frame
###   contourplot.formula contourplot.data.frame levelplot.table
###   contourplot.table levelplot.array contourplot.array levelplot.matrix
###   contourplot.matrix
### Keywords: hplot
...
### Name: F_2_llines
### Title: Replacements of traditional graphics functions
### Aliases: larrows llines lpoints lpolygon lpolypath lrect lsegments
###   ltext larrows.default llines.default lpoints.default lpolygon.default
###   lpolypath.default lrect.default lsegments.default ltext.default
###   lplot.xy panel.arrows panel.lines panel.points panel.polygon
###   panel.polypath panel.rect panel.segments panel.text
### Keywords: dplot
...
### Name: F_1_panel.cloud
### Title: Default Panel Function for cloud
### Aliases: panel.cloud panel.wireframe panel.3dscatter panel.3dwire
###   makeShadePalette
### Keywords: dplot
...
### Aliases: qq qq.formula qq.data.frame
### Keywords: dplot
...
### Aliases: qqmath qqmath.formula qqmath.data.frame qqmath.numeric
### Keywords: dplot
...
### Aliases: tmd tmd.formula tmd.data.frame tmd.trellis
...
### Aliases: xyplot xyplot.formula xyplot.data.frame barchart
###   barchart.formula barchart.data.frame barchart.numeric
###   barchart.default bwplot bwplot.formula bwplot.data.frame
###   bwplot.numeric dotplot dotplot.formula dotplot.data.frame
###   dotplot.numeric dotplot.default stripplot stripplot.formula
