...
###   .Tk.newwin .Tk.subwin is.tkwin tkdestroy .TkRoot .TkUp addTclPath
...
##D ls(envir = top$env, all.names = TRUE)
## End(Not run)
...
##D   # list themes
##D   themes <- as.character(tcl("ttk::style", "theme", "names"))
##D   themes
##D   # select a theme -- for pre-XP windows
##D   #   tcl("ttk::style", "theme", "use", "winnative")
##D   tcl("ttk::style", "theme", "use", themes[1])
##D } else {
